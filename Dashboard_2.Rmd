...
This tab features two interactive functions, the first predicting movie performance if the movie was released in a different year, as well as an interactive function to predict movie performance based on user input. 
...
### 📘 How to Read These Graphs {data-width=400}

<span style="color: #246A73;">**Understanding Figure 1: MSE and R² Comparison**</span>
